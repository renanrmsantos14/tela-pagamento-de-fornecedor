...
(() => {
  ...
  const tableColumns = {
    ...
    cr40f_eventopagamentoaterceiro: [
      ...
      picklistColumn("cr40f_Operacao", "Operação", [
        { value: 100000000, label: "Criado" },
        { value: 100000001, label: "Email enviado" },
        { value: 100000002, label: "Email reenviado" },
        { value: 100000003, label: "Pagamento registrado" },
        { value: 100000004, label: "Comprovante anexado" },
        { value: 100000005, label: "Falha de notificação" },
        { value: 100000006, label: "Rascunho atualizado" },
        { value: 100000007, label: "Cancelado" },
        { value: 100000008, label: "Pagamento revertido" },
        { value: 100000009, label: "Falha documental" },
      ]),
